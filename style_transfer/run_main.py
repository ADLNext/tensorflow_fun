...
def parse_args():
    ...
    parser.add_argument('--max_size', type=int, default=1024, help='The maximum width or height of input images')
    ...
    parser.add_argument('--num_iter', type=int, default=500, help='The number of iterations to run')
